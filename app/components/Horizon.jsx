  ...
  const contents = [
    {
      ...
      description:
        "This is my year 4 final project using React, nodeJS and PostgreSQL. This project is about displaying and showing floor plans and information or activities in the KMITL building and letting students book rooms. In the admin zone , it can display room usage to analyze data.",
    ...
    },
    {
      ...
      description:
        "I had the opportunity to intern at Bangkok Web Solution Co.,Ltd. as a back end developer.",
    ...
    },
    {
      ...
      description:
        "this is education web site, by telling the story of the history of bus number 8.",
    ...
    },
    {
      ...
      description:
        "This is a game multiplayer web site, which is an X/O game that has skills to make it more fun and challenging for the player.",
    ...
    },
    {
      ...
      description:
        "This is a mockup project, a mockup meb market website for learn something about web layout and front-end function.",
    ...
    },
    {
      ...
      description:
        "This is department store management system using Java language, which lets users add products and manage them.",
